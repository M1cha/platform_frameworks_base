...
int register_android_server_BatteryService(JNIEnv* env)
{
    ...
    if (dir == NULL) {
        // This indicates the kernel is built with
        // CONFIG_POWER_SUPPLY disabled. 
        // This should be treated the same as a kernel with
        // CONFIG_POWER_SUPPLY enabled, but not finding a
        // power supply -- simply make sure all paths in
        // gPaths are NULL
        // jniRegisterNativeMethods etc. still should be run.
